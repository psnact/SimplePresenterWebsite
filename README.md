...
The macOS download buttons point to:

`https://github.com/psnact/SimplePresenter/releases/latest/download/SimplePresenterARM.dmg`

`https://github.com/psnact/SimplePresenter/releases/latest/download/SimplePresenterIntel.dmg`
...
3. The DMGs are hosted on GitHub Releases (no local `downloads/` folder required).
